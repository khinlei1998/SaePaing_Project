                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="row">
                            ...
                            <a class="position-absolute add-button-link mt-4 mr-3">
                                <button class="btn add-button text-white" data-toggle="modal" data-target="#addcbp"><i
                                            class="fas fa-plus-circle"></i> Add New CMP
                                </button>
                            </a>
                        </div>
                        <hr>
                                ...
                                <div class="col-md-4">
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                                    ...
                                                    <a class="collapsed" role="button">
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <form action="{{ route('cbplist.destroy',$list->cbp_id) }}"
                                                                          method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                            ...
                                            <div id="collapse{{$list->cbp_id}}" class="panel-collapse collapse"
                                                 role="tabpanel" aria-labelledby="headingOne">
                                                <div class="shadow p-3 mb-3 bg-white rounded panel-body pt-5 rounded">
                                                    <button type="button" class="btn btn-secondary btn-sm btn-block"
                                                            data-toggle="collapse"
                                                            data-target="#filter-panel{{$list->cbp_id}}"> Add New
                                                        Subtask
                                                    </button>
                                                    <div class="container" id="filter-panel{{$list->cbp_id}}">
                                                        <form method="GET" class="form-horizontal m-t-20"
                                                              action="{{ url('cbp') }}">
                                                            {{ csrf_field() }}
                                                            <div class="row collapse mt-3"
                                                                 id="filter-panel{{$list->cbp_id}}">
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <input type="text" name="cbp_subtask"
                                                                                   placeholder="Enter a new subtask"
                                                                                   class="form-control"/>
                                                                            <input type="hidden" name="cbp_id"
                                                                                   value="{{$list->cbp_id}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                @if($value->cbp_id === $list->cbp_id)
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <ul class="pl-3">
                                                                            ...
                                                                            <input type="hidden" name="cbp_subtask[]"
                                                                                   value="{{$value->id}}">
                                                                        </ul>
                                                                    </div>

                                                                    <div class="col-md-2">
                                                                        <form action="{{ route('cbp_config.destroy', $value->id) }}"
                                                                              method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
