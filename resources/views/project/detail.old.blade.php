...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2 mb-3" id="show_noti_box" data-config_id="61">
...
$to_check_cbp_id=DB::table('project_configs')->where([['cbp_id','=',$gcl->cbp_id],['project_id','=',$project->project_id]]);
?>
            ...
            $(function () {
                $('.showsubcbp').click(function () {
                    ...
                    $.ajax({
                        ...
                        for( var j=0;j<data.all_reports.length;j++){
                             var ss="<div>ffff</div>";                    
                             $('#subcbpcontainer').append(subcbp);
                                   
                                                    console.log(data.all_reports[j]);                     
                         }
