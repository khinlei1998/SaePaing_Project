                                            ...
                                            <div class="col-4">
                                                <div class="card " style="width: 11.87rem;">
                                                    ...
                                                    <div class="card-body text-center">
                                                        <button type="button" class="btn btn-primary btnprofile"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img id="pp" src="{{url('/storage/profile/'.$img)}}"
                                                                 class="profile_image" alt="Cinque Terre">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="row mt-3 mb-3 justify-content-center text-muted pb-3">
                                                        ...
                                                        <div class="col-md-2 col-sm-4 text-md-center">
                                                            <small><span class="bg-info mr-2">&nbsp;&nbsp;</span>Assigned
                                                        ...
                                                        <div class="col-md-2 col-sm-4 text-md-center">
                                                            <small><span class="bg-success mr-2">&nbsp;&nbsp;</span>Started
                                                        ...
                                                        <div class="col-md-2 col-sm-4 text-md-center">
                                                            <small><span class="bg-secondary mr-2">&nbsp;&nbsp;</span>Complete
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row mt-3 mb-3 justify-content-center text-muted pb-3">
                                                    ...
                                                    <div class="col-md-2 col-sm-4 text-md-center">
                                                        <small><span
                                                                    class="bg-info mr-2">&nbsp;&nbsp;</span>Assigned {{ $employee->missions()->where('status','0')->count() }}
                                                        </small>
                                                    </div>
                                                    <div class="col-md-2 col-sm-4 text-md-center">
                                                        <small><span
                                                                    class="bg-success mr-2">&nbsp;&nbsp;</span>Started{{ $employee->missions()->where('status','1')->count() }}
                                                        </small>
                                                    </div>
                                                    <div class="col-md-2 col-sm-4 text-md-center">
                                                        <small><span class="bg-secondary mr-2">&nbsp;&nbsp;</span>Complete{{ $employee->missions()->where('status','2')->count() }}
                                                        </small>
                                                    </div>
                                                        ...
                                                        @foreach ($missions=$employee->missions()->paginate(4) as $mission)
                                                            ...
                                                            <tr class="row-color {{ $mission->mission_status }}">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if($mission->status==2)
                                                                        <form action="{{ route('approveTask',$mission) }}"
                                                                              method="POST">
                                                                            {{ csrf_field() }}
                                                                            <button data-toggle="tooltip"
                                                                                    data-placement="left"
                                                                                    title="Approve Task"
                                                                                    class="btn shadow btn-success text-white w-100">
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-md-11">
                                                                                                                ...
                                                                                                                <small>
                                                                                                                    Total
                                                                                                                    SubTask
                                                                                                                    - {{ count(explode(",",$cbplist->cbp_subtask)) }} </small>
                                                                                                                <div>
                                                                                                                    <br>
                                                                                                                </div>
                                                                                                                <div class="progress progress-profile">
                                                                                                                    ...
                                                                                                                    @else
                                                                                                                        <div class="progress-bar bg-danger"
                                                                                                                             role="progressbar"
                                                                                                                             style="width: {{$get_per->first()->percentage}}%;"
                                                                                                                             aria-valuenow="25"
                                                                                                                             aria-valuemin="0"
                                                                                                                             aria-valuemax="100">{{$get_per->first()->percentage}}
                                                                                                                            %
                                                                                                                        </div>
                                                                                                                        ...
                                                                                                                        <div class="container hod-subtask">
                                                                                                                            <div class="row">
                                                                                                                                ...
                                                                                                                                <!-- <div class="cog-icon show_cbp_hot"    data-configid="{{$cbplist['id']}}"   data-subcbpid="{{$sublist['id']}}" data-projectid="{{$cbplist['project_id']}}" data-subcbptitle="{{$sublist['cbp_subtask']}}"  data-subcbptitle="{{$sublist['cbp_subtask']}}"  ><i class="fa fa-cog"></i></div> -->
                                                                                                                                    ...
                                                                                                                                    <div class="cog-icon show_cbp_hot"
                                                                                                                                         onclick="myFunction({{$assignhot}},{{$sublist['id']}},'{{$sublist['cbp_subtask']}}','{{$cbplist['project_id']}}','{{$cbplist['id']}}','{{$sublist['id']}}')">
                                                                                                                                        <i class="fa fa-cog"></i>
                                                                                                                                    </div>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header modal-header-config">
                                                                                <h5 class="modal-title"><i
                                                                                            class="fa fa-cog"></i>&nbsp;&emsp;<p
                                                                                            id="cbp_sub_task_title"
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" id="btn_cbp_hot"
