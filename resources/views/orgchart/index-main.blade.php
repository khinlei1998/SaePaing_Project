...
@section('content')
 ...
 <div class="breadcomb-area breadcomb-area2">
        <div class="container">
            <div class="row">
                                      ...
                                      <ul class="org director">
                                        <li class="org">
                                          <a class="org"  href="#"  style="margin-bottom: 10px;background:#005569;color:#fff;position:relative;top:10px;"><span >Board of Directors</span></a>
                                            <a class="org"  href="#" style="margin-bottom: 0px;background:#005569;color:#fff;position:relative;top:10px;"><span>Chairman</span></a>
                                          ...
                                          <ul class="org departments cf">                                
                                            ...
                                            <li class=" org department dep-b" style="margin-left:186px;">
                                              <a class="org"  href="{{ route('OC_group', '1') }}"><span>Group I</span></a>
                                            </li>
                                            <li class=" org department dep-c">
                                              <a class="org"  href="{{ route('OC_group', '2') }}"><span>Group II</span></a>
                                            </li>
                                            <li class=" org department dep-d">
                                              <a class="org"  href="{{ route('OC_group', '3') }}"><span>Group III</span></a>
                                            </li>
                                            <li class=" org department dep-e">
                                              <a class="org"  href="{{ route('OC_group', '4') }}"><span>Group IV</span></a>
                                            </li>
                                              <li class=" org department dep-e">
                                              <a class="org"  href="{{ route('OC_group', '5') }}"><span>Group V</span></a>
                                            </li>
                                          </ul>
                                        </li>
                                      </ul>    
